    ...
    <section className="py-20 md:py-28 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">The MA Bags Difference</h2>
          <p className="text-lg text-muted-foreground">
            Experience the quality and service that sets us apart from the rest
          </p>
        </motion.div>
